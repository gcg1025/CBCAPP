...
@interface PriceClassTitleV()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@implementation PriceClassTitleV
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.deleteBlock) {
        PriceClassM *model =  self.model.subClass[indexPath.row];
...
- (void)confirmAct:(id)sender {
    if (self.confirmBlock) {
        [Tool setPriceClassIDAry:self.model.subClass.copy];
        self.confirmBlock();
    }
}
